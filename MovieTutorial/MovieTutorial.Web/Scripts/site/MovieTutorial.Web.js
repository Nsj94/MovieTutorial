        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = MovieTutorial.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = MovieTutorial.Northwind.OrderDetailsEditor;
        ...
        var StaticTextBlockForm = /** @class */ (function (_super) {
            ...
            function StaticTextBlockForm(prefix) {
                ...
                if (!StaticTextBlockForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = MovieTutorial.StaticTextBlock;
                    var w1 = s.StringEditor;
...
(function (MovieTutorial) {
    ...
    (function (Default) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'MovieTutorial.Default.Gender', 'Default.Gender');
    })(Default = MovieTutorial.Default || (MovieTutorial.Default = {}));
})(MovieTutorial || (MovieTutorial = {}));
var MovieTutorial;
(function (MovieTutorial) {
    var Default;
...
(function (MovieTutorial) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'MovieTutorial.Northwind.Gender', 'MovieTutorial.Northwind.Entities.Gender');
    })(Northwind = MovieTutorial.Northwind || (MovieTutorial.Northwind = {}));
})(MovieTutorial || (MovieTutorial = {}));
var MovieTutorial;
(function (MovieTutorial) {
...
(function (MovieTutorial) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(OrderShippingState, 'MovieTutorial.Northwind.OrderShippingState', 'Northwind.OrderShippingState');
    })(Northwind = MovieTutorial.Northwind || (MovieTutorial.Northwind = {}));
})(MovieTutorial || (MovieTutorial = {}));
var MovieTutorial;
(function (MovieTutorial) {
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        MovieTutorial.Common.ReportHelper.execute({
        ...
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    MovieTutorial.Northwind.CategoryService.Retrieve({
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(MovieTutorial.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new MovieTutorial.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                MovieTutorial.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(MovieTutorial.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    MovieTutorial.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(MovieTutorial.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(MovieTutorial.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    MovieTutorial.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return MovieTutorial.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return MovieTutorial.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return MovieTutorial.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return MovieTutorial.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                MovieTutorial.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
        ...
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    MovieTutorial.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    ...
                    if (productID != null) {
                        _this.form.UnitPrice.value = MovieTutorial.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return MovieTutorial.Northwind.OrderDetailRow.localTextPrefix; };
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return MovieTutorial.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new MovieTutorial.Northwind.OrderDetailForm(_this.idPrefix);
...
(function (MovieTutorial) {
    ...
    MovieTutorial.SelectableEntityGrid = SelectableEntityGrid;
})(MovieTutorial || (MovieTutorial = {}));
...
(function (MovieTutorial) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return MovieTutorial.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return MovieTutorial.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return MovieTutorial.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return MovieTutorial.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(MovieTutorial.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = MovieTutorial.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            MovieTutorial.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (MovieTutorial) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return MovieTutorial.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return MovieTutorial.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return MovieTutorial.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return MovieTutorial.Northwind.ProductService.baseUrl; };
...
(function (MovieTutorial) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return MovieTutorial.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return MovieTutorial.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return MovieTutorial.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return MovieTutorial.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (MovieTutorial) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return MovieTutorial.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return MovieTutorial.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (MovieTutorial) {
    ...
    MovieTutorial.StaticTextBlock = StaticTextBlock;
})(MovieTutorial || (MovieTutorial = {}));
var MovieTutorial;
(function (MovieTutorial) {
    var Common;
    ...
    (function (Default) {
        var MovieGrid = /** @class */ (function (_super) {
            ...
            MovieGrid.prototype.getQuickSearchFields = function () {
                var txt = function (s) {
                    return Q.text("Db." + Default.MovieRow.localTextPrefix + "." + s).toLowerCase();
                };
                return [
                    { name: "", title: "all" },
...
(function (MovieTutorial) {
    ...
    (function (Default) {
        var MovieCastDialog = /** @class */ (function (_super) {
            ...
            MovieCastDialog.prototype.getFormKey = function () { return Default.MovieCastForm.formKey; };
            MovieCastDialog.prototype.getIdProperty = function () { return Default.MovieCastRow.idProperty; };
            MovieCastDialog.prototype.getLocalTextPrefix = function () { return Default.MovieCastRow.localTextPrefix; };
            MovieCastDialog.prototype.getNameProperty = function () { return Default.MovieCastRow.nameProperty; };
            MovieCastDialog.prototype.getService = function () { return Default.MovieCastService.baseUrl; };
            MovieCastDialog.prototype.getDeletePermission = function () { return Default.MovieCastRow.deletePermission; };
            MovieCastDialog.prototype.getInsertPermission = function () { return Default.MovieCastRow.insertPermission; };
            MovieCastDialog.prototype.getUpdatePermission = function () { return Default.MovieCastRow.updatePermission; };
            MovieCastDialog = __decorate([
                Serenity.Decorators.registerClass()
            ], MovieCastDialog);
            return MovieCastDialog;
        }(Serenity.EntityDialog));
        Default.MovieCastDialog = MovieCastDialog;
    })(Default = MovieTutorial.Default || (MovieTutorial.Default = {}));
})(MovieTutorial || (MovieTutorial = {}));
/// <reference path="../../Common/Helpers/GridEditorDialog.ts" />
var MovieTutorial;
...
(function (MovieTutorial) {
    ...
    (function (Default) {
        var MovieCastEditor = /** @class */ (function (_super) {
            ...
            MovieCastEditor.prototype.getColumnsKey = function () { return "Default.MovieCast"; };
            MovieCastEditor.prototype.getDialogType = function () { return Default.MovieCastEditDialog; };
            MovieCastEditor.prototype.getLocalTextPrefix = function () { return Default.MovieCastRow.localTextPrefix; };
...
(function (MovieTutorial) {
    ...
    (function (Default) {
        var MovieCastGrid = /** @class */ (function (_super) {
            ...
            MovieCastGrid.prototype.getColumnsKey = function () { return 'Default.MovieCast'; };
            MovieCastGrid.prototype.getDialogType = function () { return Default.MovieCastDialog; };
            MovieCastGrid.prototype.getIdProperty = function () { return Default.MovieCastRow.idProperty; };
            MovieCastGrid.prototype.getInsertPermission = function () { return Default.MovieCastRow.insertPermission; };
            MovieCastGrid.prototype.getLocalTextPrefix = function () { return Default.MovieCastRow.localTextPrefix; };
            MovieCastGrid.prototype.getService = function () { return Default.MovieCastService.baseUrl; };
            MovieCastGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], MovieCastGrid);
            return MovieCastGrid;
        }(Serenity.EntityGrid));
        Default.MovieCastGrid = MovieCastGrid;
    })(Default = MovieTutorial.Default || (MovieTutorial.Default = {}));
})(MovieTutorial || (MovieTutorial = {}));
var MovieTutorial;
(function (MovieTutorial) {
